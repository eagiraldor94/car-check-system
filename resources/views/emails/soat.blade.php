...
<div class="row">
	...
	<h3 class="align-self-center" style="color:#000; text-decoration: none; font-size: 18px">La plataforma <span style="color:#000; text-decoration: none;">{{$param_name}}</span> le informa que <b>el SOAT para el vehículo de placa {{$plate}} se encuentra proximo a vencer.</b></h3>
	</div>
